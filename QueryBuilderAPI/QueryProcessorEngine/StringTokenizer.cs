...
namespace QueryProcessorEngine
{
	...
	public class StringTokenizer
	{
		...
		protected Token CreateToken(string kind, string value)
		{
			return new Token(kind, value, line, column);
		}

		protected Token CreateToken(string kind)
		{
		...
		public Token Next()
		{
			...
			{
				case EOF:
					return CreateToken("EOF", string.Empty);
		...
		protected Token ReadString()
		{
			...
			return CreateToken("QuotedString");
		}
